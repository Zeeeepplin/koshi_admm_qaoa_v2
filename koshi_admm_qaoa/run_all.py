...
def main():
    ...
    print(f"[3/6] AC base case (meshed): loss={r['loss_mw']:.3f} MW, connected={r['connected']}")
    ...
    run_benchmark(sizes=(4, 6, 8, 10, 12), seeds=(42, 7), reps_list=(1, 2),
                  shots=1024, maxiter=40, ground_truth_max_size=8)
    make_plots()

    import make_summary  # writes RESULTS_SUMMARY.md
